  ...
  <div class="form-container">
      <form @submit.prevent="Register">
          ...
          <div class="form-group">
              ...
              <div v-if="errorMessage.pseudo" class="error-message" v-for="error in errorMessage.Pseudo" :key="error">{{ error }}</div>
          </div>
  
          <div class="form-group">
              <label for="form_password">Mot de passe</label>
              <div class="password-wrapper">
                  <input :type="showPassword ? 'text' : 'password'" id="form_password" v-model="form.password" class="input-field"/>
          ...
          <div class="form-group">
              ...
              <div class="password-wrapper">
                  <input :type="showPassword ? 'text' : 'password'" id="password_confirmation" v-model="form.password_confirmation" class="input-field"/>
                  <button type="button" class="toggle-password" @click="togglePasswordVisibility">
                      <!-- Icône œil ouverte/fermée -->
                      <span v-if="showPassword">👁️</span>
                      <span v-else>👁️‍🗨️</span>
